...
- `manifest/` — living-spec generator for `CLAUDE.md` (vendored from `The-Interdependency/skill-lib@ddec346`); CI runs `generate.py --check`. Refresh with `python .agents/skills/manifest/generate.py --write`.
